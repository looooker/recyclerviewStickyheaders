...
public class HeaderStore
{
    ...
    private final HashMap<Long, Integer> headersWidthsByItemsIds;
    ...
    public HeaderStore(RecyclerView parent, StickyHeadersAdapter adapter, boolean isSticky)
    {
        ...
        this(parent, adapter, null, isSticky);
    }

    public HeaderStore(RecyclerView parent, StickyHeadersAdapter adapter, View topView, boolean isSticky)
    {
        this.parent = parent;
        ...
        this.headersWidthsByItemsIds = new HashMap<Long, Integer>();
    ...
    public int getHeaderWidth(RecyclerView.ViewHolder itemHolder)
    {

        if (!headersWidthsByItemsIds.containsKey(itemHolder.getItemId()))
        {
            View header = getHeaderViewByItem(itemHolder);
            headersWidthsByItemsIds.put(itemHolder.getItemId(), header.getVisibility() == View.GONE ? 0 : header.getMeasuredWidth());
        }

        return headersWidthsByItemsIds.get(itemHolder.getItemId());
    }
    ...
    public int getTopWidth()
    {
        ...
        {
            layoutHeader(topView);
            return topView.getMeasuredWidth();
        }
        else
        {
            return 0;
